...
-- QUERY 4
SELECT a2.BOOK_title, a3.BORROWER_Name, a3.BORROWER_Address FROM tbl_LIBRARY_BRANCH a1
INNER JOIN tbl_BOOK a2 ON a2.BOOK_Id = a1.LIBRARY_BRANCH_BranchId
INNER JOIN tbl_BOOK_LOANS a4 ON a4.BOOK_LOANS_BranchId = a1.LIBRARY_BRANCH_BranchId
INNER JOIN tbl_BORROWER a3 ON a3.BORROWER_CardNo = a4.BOOK_LOANS_CardNo
WHERE a4.BOOK_LOANS_DueDate = '1/20' AND a1.LIBRARY_BRANCH_BranchName = 'Sharpstown';
